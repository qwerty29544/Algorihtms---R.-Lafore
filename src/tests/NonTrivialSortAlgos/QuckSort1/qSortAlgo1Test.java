...
public class qSortAlgo1Test {

    qSortAlgo1 qSortAlgo1, qSort, qSortException;

    @Before
    public void setUp() throws Exception {
        this.qSort = new qSortAlgo1(22);
        ...
        this.qSortAlgo1 = new qSortAlgo1(10);
    }

    @Test(expected = NegativeArraySizeException.class)
    public void setUpException() {
        this.qSortException = new qSortAlgo1(-10);
    }
    ...
    public void getnElems() throws Exception {
        assertEquals(this.qSort.getnElems(),7);
        this.qSort.insert(1);
        assertEquals(this.qSort.getnElems(),8);
        this.qSort.quickSort();
        assertEquals(this.qSort.getnElems(),8);
        this.qSort.insert(0);
        assertEquals(this.qSort.getnElems(),9);
    }

    @Test(expected = NullPointerException.class)
    public void getnElemsException() {
        this.qSortException.getnElems();
    }
