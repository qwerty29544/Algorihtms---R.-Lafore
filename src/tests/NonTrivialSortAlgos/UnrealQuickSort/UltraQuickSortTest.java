...
public class UltraQuickSortTest {

    UltraQuickSort qSortAlgo1, qSort, qSortException, quickSortThree;

    @Before
    public void setUp() throws Exception {
        this.qSort = new UltraQuickSort(22);
        ...
        this.qSortAlgo1 = new UltraQuickSort(10);
        this.quickSortThree = new UltraQuickSort(3);
    ...
    public void setUpException() {
        this.qSortException = new UltraQuickSort(-10);
    }
    ...
    public void insertionSort() throws Exception {
        ...
        assertEquals(this.qSort.getTheArray()[5],54);
        assertEquals(this.qSort.getTheArray()[6],21);
        this.qSort.insertionSort(0,this.qSort.size()-1);
        assertEquals(this.qSort.getTheArray()[0],-109);
        assertEquals(this.qSort.getTheArray()[1],-13);
        assertEquals(this.qSort.getTheArray()[2],5);
        assertEquals(this.qSort.getTheArray()[3],10);
        ...
        assertEquals(this.qSort.getTheArray()[6],222);
        assertEquals(this.qSort.getTheArray()[7],0);
        this.qSort.insertionSort(0,this.qSort.size());
        assertEquals(this.qSort.getTheArray()[0],-109);
        assertEquals(this.qSort.getTheArray()[1],-13);
        assertEquals(this.qSort.getTheArray()[2],0);
        assertEquals(this.qSort.getTheArray()[3],5);
        assertEquals(this.qSort.getTheArray()[4],10);
        assertEquals(this.qSort.getTheArray()[5],21);
        assertEquals(this.qSort.getTheArray()[6],54);
        assertEquals(this.qSort.getTheArray()[7],222);
    }

    @Test(expected = NullPointerException.class)
    public void insertionSortException() {
        this.qSortException.insertionSort(0,this.qSortException.size()-1);
    }
